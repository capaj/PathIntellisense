...
suite('PathIntellisense Require/Import Tests', () => {
  test('in requirestring', () =>
    assert.equal(true, should("require('./')", 11)))
  test('in requirestring - no .', () =>
    assert.equal(false, should("require('/')", 10)))
  test('in importstring', () =>
    assert.equal(true, should("import {} from './'", 18)))
})
